 ...
 *
 */
public class CuentasPorCobrarPanel2 extends FilteredBrowserPanel<CargoRow2> {
	...
	public Action[] getActions() {
		if(actions==null){
			this.actions=new Action[]{
				...
				,addAction(CXCActions.GenerarNotaDeDevolucion.getId(), "generarNotasDeDevolucionCre", "Devoluciones (Credito)" )
				...
				,addAction("", "print", "Imprimir Pagare")
	...
	public void generarNotasDeDevolucionCre(){
		Devolucion devolucion=SelectorDeDevoluciones.seleccionar(OrigenDeOperacion.CRE);
		if(devolucion!=null){
