...
public class RecordatorioPreview extends SXAbstractDialog {
	
	private URL url;
	private String text;
	private final Cliente cliente;
	
	public RecordatorioPreview(final URL url,final Cliente c) {
		super("Recordatorio de pago");
		this.url=url;
		this.cliente=c;
	}
	
	public RecordatorioPreview(final String text,final Cliente c) {
		super("Recordatorio de pago");
		this.text=text;
		this.cliente=c;
