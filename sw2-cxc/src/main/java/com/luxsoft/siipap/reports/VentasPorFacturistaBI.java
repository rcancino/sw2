 ...
 *
 */
public class VentasPorFacturistaBI extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/VentasFacturista.jasper"), form.getParametros());
	...
	public static void run(){
		VentasPorFacturistaBI action=new VentasPorFacturistaBI();
		action.execute();
	}
