 ...
 *
 */
public class FacturasPendientesCamioneta extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
						ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/fac_pen_camioneta.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public static void run(){
		FacturasPendientesCamioneta action=new FacturasPendientesCamioneta();
		action.execute();
	}
