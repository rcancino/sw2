 ...
 *
 */
public class RelacionDeChequesDevueltosReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			if(logger.isDebugEnabled()){
				...
				ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/RelacionDeCheques.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Relacion De Cheques Devueltos");
		...
		public void doApply() {			
			...
			if(model.getValue("cliente")!=null ){
				...
				parametros.put("FECHA_FIN", model.getValue("fechaInicial"));
			}
	...
	public static void run(){
		RelacionDeChequesDevueltosReport action=new RelacionDeChequesDevueltosReport();
		action.execute();
	}
