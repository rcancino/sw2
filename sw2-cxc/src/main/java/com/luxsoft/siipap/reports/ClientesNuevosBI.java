 ...
 *
 */
public class ClientesNuevosBI extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/ClientesNuevos.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Relación de clientes nuevos","").getHeader();
		}
	...
	public static void run(){
		ClientesNuevosBI action=new ClientesNuevosBI();
		action.execute();
	}
