 ...
 *
 */
public class ExcepcionesEnPrecioReportForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/ExcepcionesEnPrecio.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Excepciones en Precio","").getHeader();
		}
	...
	public static void run(){
		ExcepcionesEnPrecioReportForm action=new ExcepcionesEnPrecioReportForm();
		action.execute();
	}
