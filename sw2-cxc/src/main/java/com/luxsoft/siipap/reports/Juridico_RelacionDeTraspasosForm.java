 ...
 *
 */
public class Juridico_RelacionDeTraspasosForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/TraspasoAJuridico.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Reporte de Traspasos a Jurídico");
		...
		protected JComponent buildHeader() {
			return new HeaderPanel("Reporte de Traspasos a Jurídico","Reporte de Traspasos a Jurídico");
		}
	...
	public static void run() {
		Juridico_RelacionDeTraspasosForm action=new Juridico_RelacionDeTraspasosForm();
		action.execute();
	}
