 ...
 *
 */
public class ExcepcionesEnDesctoReportForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/ExcepcionesEnDescuento.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Excepciones en Descuento","").getHeader();
		}
	...
	public static void run(){
		ExcepcionesEnDesctoReportForm action=new ExcepcionesEnDesctoReportForm();
		action.execute();
	}
