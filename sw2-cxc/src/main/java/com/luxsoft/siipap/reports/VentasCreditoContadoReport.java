...
public class VentasCreditoContadoReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			if(form.getCk().isSelected()==true){
				//ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/VentasCreditoContado_Resumen.jasper"), form.getParametros());
			}			
            if(form.getCk().isSelected()==false){
            	ReportUtils.viewReport(ReportUtils
            			.toReportesPath("ventas/VentaNetaPorPeriodo.jasper"), form.getParametros());	
			}
	...
	public class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader() {
			return new HeaderPanel("Ventas Netas"
					,"Reporte de ventas netas  a Detalle y  Resumen");
		}
