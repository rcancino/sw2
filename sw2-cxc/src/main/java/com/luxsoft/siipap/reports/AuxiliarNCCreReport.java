 ...
 *
 */
public class AuxiliarNCCreReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/DesctoCreditoXDia.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Auxiliar Notas Crédito/Cargo");
		...
		private void initComponents(){			
			f1=new JXDatePicker();
			f2=new JXDatePicker();
			f1.setFormats(new String[]{"dd/MM/yyyy","dd/MM/yy"});
			f2.setFormats(new String[]{"dd/MM/yyyy","dd/MM/yy"});
		}
	...
	public static void main(String[] args) {
		AuxiliarNCCreReport action=new AuxiliarNCCreReport();
		action.execute();
	}
