 ...
 *
 */
public class ChequesDevueltos_RelacionForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/RelacionChequesDevueltos.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public static void run(){
		ChequesDevueltos_RelacionForm action=new ChequesDevueltos_RelacionForm();
		action.execute();
	}
