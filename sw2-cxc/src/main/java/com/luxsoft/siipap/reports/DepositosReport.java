 ...
 *
 */
public class DepositosReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/Depositos.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader() {
			return new HeaderPanel("Depositos","Reporte Depositos");
		}
	...
	public static void main(String[] args) {
		...
		DepositosReport action=new DepositosReport();
		action.execute();
	}
