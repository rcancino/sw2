 ...
 *
 */
public class ProyeccionDeCobranzaReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/ProyeccionCobranzaCxC.jasper"), form.getParametros());
					}
		form.dispose();
	}
	...
	public static void run() {
		ProyeccionDeCobranzaReport action=new ProyeccionDeCobranzaReport();
		action.execute();
	}
