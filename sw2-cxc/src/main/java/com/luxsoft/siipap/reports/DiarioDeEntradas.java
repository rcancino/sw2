...
/**
 * Genera el reporte de diario de entrada
 * 
 * @author Ruben Cancino
 *
 */
public class DiarioDeEntradas extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxp/DiarioDeEntradas.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Diario de entradas ","").getHeader();
		}
	...
	public static void main(String[] args) {
		DiarioDeEntradas action=new DiarioDeEntradas();
		action.execute();
	}
