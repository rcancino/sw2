 ...
 *
 */
public class RmdCobranzaContadoReportForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("CXC/Rmds.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("RMD'S ","").getHeader();
		}
	...
	public static void run(){
		RmdCobranzaContadoReportForm action=new RmdCobranzaContadoReportForm();
		action.execute();
	}
