 ...
 *
 */
public class VentasGlobalesBI extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/VentasGlobales.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Reporte de Ventas Globales","").getHeader();
		}
	...
	public static void run(){
		VentasGlobalesBI action=new VentasGlobalesBI();
		action.execute();
	}
