 ...
 *
 */
public class ProvisionReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/PROVISIONDET.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public static void main(String[] args) {
		ProvisionReport action=new ProvisionReport();
		action.execute();
	}
