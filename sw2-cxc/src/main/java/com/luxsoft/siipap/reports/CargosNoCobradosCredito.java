 ...
 *
 */
public class CargosNoCobradosCredito extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/CargosNoCobrados.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Cargos No Cobrados Credito");
		}
		...
		protected JComponent buildHeader(){
			return new Header("Reporte de cargos no cobrados credito","").getHeader();
		}
	...
	public static void run(){
		CargosNoCobradosCredito action=new CargosNoCobradosCredito();
		action.execute();
	}
