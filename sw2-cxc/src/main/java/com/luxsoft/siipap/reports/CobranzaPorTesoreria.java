 ...
 *
 */
public class CobranzaPorTesoreria extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/CobranzaEspecial.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Relación de cobranza Por Tesoreria","").getHeader();
		}
	...
	public static void run(){
		CobranzaPorTesoreria action=new CobranzaPorTesoreria();
		action.execute();
	}
