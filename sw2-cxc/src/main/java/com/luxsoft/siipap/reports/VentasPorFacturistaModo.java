 ...
 *
 */
public class VentasPorFacturistaModo extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/VentasFacturistaModo.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Ventas Por Facturista","").getHeader();
		}
	...
	public static void run(){
		VentasPorFacturistaModo action=new VentasPorFacturistaModo();
		action.execute();
	}
