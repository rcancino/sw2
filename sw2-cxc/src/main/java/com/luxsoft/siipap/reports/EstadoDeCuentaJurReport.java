 ...
 *
 */
public class EstadoDeCuentaJurReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/EstadoDeCuentaJur.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public static void run(){
		EstadoDeCuentaJurReport action=new EstadoDeCuentaJurReport();
		action.execute();
	}
