 ...
 *
 */
public class RevisionCobroReportForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("cxc/FacturasAcobroYRevision.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public static void main(String[] args) {
		RevisionCobroReportForm action=new RevisionCobroReportForm();
		action.execute();
	}
