...
public class ListaDePreciosClienteDetForm extends GenericAbstractForm<ListaDePreciosClienteDet>{

	public ListaDePreciosClienteDetForm(IFormModel model) {
		super(model);
	}
	...
	protected JComponent buildForm() {
		...
		builder.append("Precio Kilo",getControl("precioKilo"),1);
	...
	public static ListaDePreciosClienteDet showForm(final ListaDePreciosClienteDet det, boolean readOnly){
		...
		final ListaDePreciosClienteDetForm form=new ListaDePreciosClienteDetForm(model);
		form.open();
