SELECT A.FECHA,A.SUCURSAL_ID,A.CREADO_USR,A.FACTURISTA
	...
	,SUM(CASE WHEN A.TIPO='PMOSLOC' THEN REG ELSE 0 END) AS PMOSLOC
	,SUM(CASE WHEN A.TIPO='PMOSCAM' THEN REG ELSE 0 END) AS PMOSCAM
	,SUM(CASE WHEN A.TIPO='PMOSCRE' THEN REG ELSE 0 END) AS PMOSCRE		
	,SUM(CASE WHEN A.TIPO='PTELLOC' THEN REG ELSE 0 END) AS PTELLOC
	,SUM(CASE WHEN A.TIPO='PTELCAM' THEN REG ELSE 0 END) AS PTELCAM
	,SUM(CASE WHEN A.TIPO='PTELCRE' THEN REG ELSE 0 END) AS PTELCRE
	...
	UNION
	SELECT 'PMOSLOC' AS TIPO,P.fecha,P.SUCURSAL_ID,P.CREADO_USR,P.CREADO_USR AS FACTURISTA,COUNT(*) AS REG,0 AS IMPORTE
	FROM sx_pedidos P WHERE P.FECHA BETWEEN @FECHA_INI AND @FECHA_FIN AND P.SUCURSAL_ID=@SUCURSAL_ID and P.MODO='MOSTRADOR' AND P.FENTREGA='LOCAL' AND P.TIPO='CONTADO' GROUP BY P.fecha,P.SUCURSAL_ID,P.CREADO_USR
	UNION
	SELECT 'PMOSCAM' AS TIPO,P.fecha,P.SUCURSAL_ID,P.CREADO_USR,P.CREADO_USR AS FACTURISTA,COUNT(*) AS REG,0 AS IMPORTE
	FROM sx_pedidos P WHERE P.FECHA BETWEEN @FECHA_INI AND @FECHA_FIN AND P.SUCURSAL_ID=@SUCURSAL_ID and P.MODO='MOSTRADOR' AND P.FENTREGA='ENVIO' AND P.TIPO='CONTADO' GROUP BY P.fecha,P.SUCURSAL_ID,P.CREADO_USR
	UNION
	SELECT 'PMOSCRE' AS TIPO,P.fecha,P.SUCURSAL_ID,P.CREADO_USR,P.CREADO_USR AS FACTURISTA,COUNT(*) AS REG,0 AS IMPORTE
	FROM sx_pedidos P WHERE P.FECHA BETWEEN @FECHA_INI AND @FECHA_FIN AND P.SUCURSAL_ID=@SUCURSAL_ID and P.MODO='MOSTRADOR' AND P.TIPO='CREDITO' GROUP BY P.fecha,P.SUCURSAL_ID,P.CREADO_USR
	UNION	
	SELECT 'PTELLOC' AS TIPO,P.fecha,P.SUCURSAL_ID,P.CREADO_USR,P.CREADO_USR AS FACTURISTA,COUNT(*) AS REG,0 AS IMPORTE
	FROM sx_pedidos P WHERE P.FECHA BETWEEN @FECHA_INI AND @FECHA_FIN AND P.SUCURSAL_ID=@SUCURSAL_ID and P.MODO='TELEFONICA' AND P.FENTREGA='LOCAL' AND P.TIPO='CONTADO' GROUP BY P.fecha,P.SUCURSAL_ID,P.CREADO_USR
	UNION
	SELECT 'PTELCAM' AS TIPO,P.fecha,P.SUCURSAL_ID,P.CREADO_USR,P.CREADO_USR AS FACTURISTA,COUNT(*) AS REG,0 AS IMPORTE
	FROM sx_pedidos P WHERE P.FECHA BETWEEN @FECHA_INI AND @FECHA_FIN AND P.SUCURSAL_ID=@SUCURSAL_ID and P.MODO='TELEFONICA' AND P.FENTREGA='ENVIO' AND P.TIPO='CONTADO' GROUP BY P.fecha,P.SUCURSAL_ID,P.CREADO_USR
	UNION
	SELECT 'PTELCRE' AS TIPO,P.fecha,P.SUCURSAL_ID,P.CREADO_USR,P.CREADO_USR AS FACTURISTA,COUNT(*) AS REG,0 AS IMPORTE
	FROM sx_pedidos P WHERE P.FECHA BETWEEN @FECHA_INI AND @FECHA_FIN AND P.SUCURSAL_ID=@SUCURSAL_ID and P.MODO='TELEFONICA' AND P.TIPO='CREDITO' GROUP BY P.fecha,P.SUCURSAL_ID,P.CREADO_USR
	UNION	
