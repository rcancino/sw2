 ...
 *
 */
public class ConteoForm2 extends AbstractForm implements ListSelectionListener{
	
	

	public ConteoForm2(final ConteoController model) {
		super(model);
		setTitle("Captura de conteo de inventario 2    ("+model.getValue("sucursal")+" )");
	}
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				ConteoForm2 form=new ConteoForm2(controller);
				form.open();
