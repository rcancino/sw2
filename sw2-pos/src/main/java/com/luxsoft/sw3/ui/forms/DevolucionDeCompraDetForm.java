...
/**
 * Forma para el mantenimiento de partidas de devolucion de compra
 * 
 * @author Ruben Cancino
 *
 */
public class DevolucionDeCompraDetForm extends AbstractForm{
	
	private EventList<Producto> productos;

	public DevolucionDeCompraDetForm(IFormModel model) {
		super(model);
