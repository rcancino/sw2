 ...
 *
 */
public class PedidoDolaresForm extends AbstractForm implements ActionListener,ListSelectionListener{
	...
	public PedidoDolaresForm(final PedidoDolaresController controller) {
		super(controller);
	...
	public PedidoDolaresController getController(){
		return (PedidoDolaresController)getModel();
	}
	...
	protected JComponent buildFormPanel() {
		...
		builder.append(getTitleLabel("T.C"),getControl("tc"));
	...
	protected JComponent buildGridPanel(){
		...
		grid.getColumnExt("Precio").setCellRenderer(Renderers.getCantidadNormalTableCellRenderer());
		grid.getColumnExt("Importe").setCellRenderer(Renderers.getCantidadNormalTableCellRenderer());
	...
	public static void main(String[] args) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				PedidoDolaresController model=new PedidoDolaresController();
				PedidoDolaresForm form=new PedidoDolaresForm(model);
				form.open();
