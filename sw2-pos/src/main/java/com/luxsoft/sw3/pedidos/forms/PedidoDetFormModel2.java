...
public class PedidoDetFormModel2 extends DefaultFormModel implements PropertyChangeListener{
	...
	private void actualizarPrecio(){
		...
		setValue("precio", BigDecimal.valueOf(precio).setScale(4, RoundingMode.HALF_EVEN));
	}
