 ...
 *
 */
public class ExistenciasReportForm extends SWXAction{
	
	
	public static void run(){
		new ExistenciasReportForm().execute();
	}
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils2.runReport("invent/ExistenciaXDetalle.jasper",params);
			}
			else{
			Map params=form.getParameters();
			ReportUtils2.runReport("invent/ExistenciaXSuc.jasper",params);
			}
		}
	}
	...
	private class ReportForm extends SXAbstractDialog{
		...
		private void init(){
			filtrosBox=new JComboBox(new Object[]{
					new ParamLabelValue("POSITIVOS"		,"HAVING (I.CANTIDAD/I.FACTORU)>0"),
					new ParamLabelValue("SIN EXISTENCIA","HAVING (I.CANTIDAD/I.FACTORU)=0"),
					new ParamLabelValue("NEGATIVOS"		,"HAVING (I.CANTIDAD/I.FACTORU)<0"),
					new ParamLabelValue("POSITIVOS/NEGATIVOS","HAVING (I.CANTIDAD/I.FACTORU)<>0"),
		...
		protected JComponent buildContent() {
			...
			builder.append("General",detalleBox);
	...
	public static void main(String[] args) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				ExistenciasReportForm form=new ExistenciasReportForm();
				form.execute();
				//System.exit(0);
			}
