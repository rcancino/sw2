 ...
 *
 */
public class CierreCaja extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("ventas/CierreCaja.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Cierre de caja","").getHeader();
		}
	...
	public static void run(){
		CierreCaja action=new CierreCaja();
		action.execute();
	}
