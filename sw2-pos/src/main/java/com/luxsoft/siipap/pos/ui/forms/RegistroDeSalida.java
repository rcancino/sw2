...
public class RegistroDeSalida extends SXAbstractDialog{
	...
	public JComponent buildHeader(){
		return new HeaderPanel("Hora de salida/retorno del embarque"
	...
	public static Date seleccionar(boolean enabled){
		RegistroDeSalida form=new RegistroDeSalida();
		form.open();
