 ...
 *
 */
public class FacturasCobradas extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("ventas/FacturasCobrada.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public static void run(){
		FacturasCobradas action=new FacturasCobradas();
		action.execute();
	}
