 ...
 *
 */
public class ComSinAnalizarReportForm extends SWXAction{
	...
	public static void run(){
		ComSinAnalizarReportForm action=new ComSinAnalizarReportForm();
		action.execute();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public void doAccept() {
			...
			ReportUtils2.runReport("invent/KardexSuc.jasper", getParametros());
		}
