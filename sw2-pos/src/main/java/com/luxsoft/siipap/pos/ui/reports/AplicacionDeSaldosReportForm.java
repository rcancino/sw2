 ...
 *
 */
public class AplicacionDeSaldosReportForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("ventas/AplicacionDeSaldos.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Aplicacion de anticipos y saldos","").getHeader();
		}
	...
	public static void run(){
		AplicacionDeSaldosReportForm action=new AplicacionDeSaldosReportForm();
		action.execute();
	}
