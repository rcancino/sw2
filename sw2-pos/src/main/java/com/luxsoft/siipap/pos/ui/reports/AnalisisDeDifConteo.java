 ...
 *
 */
public class AnalisisDeDifConteo extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("INVENT/AnalisisDeDifereciasConteo.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Diferencias Conteo","").getHeader();
		}
	...
	public static void run(){
		AnalisisDeDifConteo action=new AnalisisDeDifConteo();
		action.execute();
	}
