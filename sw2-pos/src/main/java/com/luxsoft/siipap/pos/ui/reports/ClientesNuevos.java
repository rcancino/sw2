 ...
 *
 */
public class ClientesNuevos extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("ventas/ClientesNuevos.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public static void run(){
		ClientesNuevos action=new ClientesNuevos();
		action.execute();
	}
