...
public class SelectorDeClientes extends AbstractSelector<Cliente> {
	...
	private String[] properties={"clave","nombre","rfc","deCredito","creditoSuspendido","permitirCheque","chequePostfechado","chequeplus"};
	private String[] columnNames={"Clave","Nombre","RFC","Crédito","Cre Susp","Cheque","Post Fech","CheckPlus"};
	...
	public ClienteManager getManager() {
		return  Services.getInstance().getClientesManager();
	}
