...
public class CancelacionAutorizadaPanel extends FilteredBrowserPanel<Venta>{
	
	
	

	public CancelacionAutorizadaPanel() {
		super(Venta.class);
	}
	...
	public void imprimir(){
		if(getSelectedObject()==null)
			return;
		Venta factura=(Venta)getSelectedObject();
		Venta venta=Services.getInstance().getFacturasManager().buscarVentaInicializada(factura.getId());
