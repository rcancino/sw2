 ...
 *
 */
public class RelacionTPSTimbrarReportForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("INVENT/RelacionTPSPendientes.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("TPS Pendientes de Timbrar","").getHeader();
		}
	...
	public static void run(){
		RelacionTPSTimbrarReportForm action=new RelacionTPSTimbrarReportForm();
		action.execute();
	}
