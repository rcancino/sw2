 ...
 *
 */
public class RelacionAnticiposReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("ventas/RelacionDeAnticipoFac.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Relacion De Anticipos Facturados","").getHeader();
		}
	...
	public static void run(){
		RelacionAnticiposReport action=new RelacionAnticiposReport();
		action.execute();
	}
