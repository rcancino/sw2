 ...
 *
 */
public class AplicacionAnticiposReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils2.runReport("ventas/AplicacionDeAnticipoFac.jasper", form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Aplicacion De Anticipos Facturados","").getHeader();
		}
	...
	public static void run(){
		AplicacionAnticiposReport action=new AplicacionAnticiposReport();
		action.execute();
	}
