 ...
 *
 */
public class ConteoFisicoValidacionForm extends SWXAction{
	
	
	public static void run(){
		new ConteoFisicoValidacionForm().execute();
	}
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils2.runReport("invent/ValidacionDeCaptura.jasper",params);
		}
	}
	...
	public static void main(String[] args) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				ConteoFisicoValidacionForm form=new ConteoFisicoValidacionForm();
				form.execute();
				//System.exit(0);
			}
