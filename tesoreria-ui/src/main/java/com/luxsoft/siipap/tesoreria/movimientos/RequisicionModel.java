...
public class RequisicionModel extends MasterDetailFormModel{

	public RequisicionModel() {
		super(Requisicion.class);		
	}

	public RequisicionModel(Object bean, boolean readOnly) {
		super(bean, readOnly);
	}

	public RequisicionModel(Object bean) {
		super(bean);		
	}
	...
	public void commit(){
		getMasterBean().setEstado(Estado.REVISADA);
	}
