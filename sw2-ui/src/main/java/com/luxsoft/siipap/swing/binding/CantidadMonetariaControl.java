 ...
 *
 */
public class CantidadMonetariaControl extends JPanel implements PropertyChangeListener{
	...
	public CantidadMonetariaControl(final ValueModel model) {
	...
	public static void main(String[] args) {
		...
		final CantidadMonetariaControl control=new CantidadMonetariaControl(model);
