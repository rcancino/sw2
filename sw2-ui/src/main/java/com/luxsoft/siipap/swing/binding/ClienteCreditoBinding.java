...
public class ClienteCreditoBinding extends AbstractControl{
	...
	public ClienteCreditoBinding(final ValueModel valueModel){		
		cliente=valueModel;
	...
	private class ClienteHandler implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			ClienteDao dao=(ClienteDao)ServiceLocator2.getClienteManager().buscarClientesCredito();
