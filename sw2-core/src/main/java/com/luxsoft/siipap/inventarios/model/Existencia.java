 ...
 */
@Entity
@Table(name="SX_EXISTENCIAS"
	,uniqueConstraints=@UniqueConstraint(columnNames={"SUCURSAL_ID","PRODUCTO_ID","YEAR","MES"})
	)
...
public class Existencia implements Replicable ,Serializable{
    ...
    @Column(name="RECORTE_COMENTARIO")
    @Length(max=250)
    private String recorteComentario;
    
    @Column(name="RECORTE_FECHA")
    private Date recorteFecha;
	...
	public String getRecorteComentario() {
		return recorteComentario;
	}

	public void setRecorteComentario(String recorteComentario) {
		this.recorteComentario = recorteComentario;
	}

	public Date getRecorteFecha() {
		return recorteFecha;
	}

	public void setRecorteFecha(Date recorteFecha) {
		this.recorteFecha = recorteFecha;
	}
