...
public class ClienteCreditoRow {
    ...
    public ClienteCreditoRow(final Cliente c){
    	this.id=c.getId();
    ...
    public ClienteCreditoRow(Long id,String clave, String nombre, String contacto) {
    	this.id=id;
        this.clave = clave;
        this.nombre = nombre;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final ClienteCreditoRow other = (ClienteCreditoRow) obj;
		if (id == null) {
			if (other.id != null)
				return false;
