...
public class CierreAnualManager {
	
	protected Logger logger=LoggerHelper.getLogger();
	
	/**
	 * Genera el cierre anual del ejercicio  
	 * 
	 * @param year
	 */
	@Transactional(propagation=Propagation.SUPPORTS)
	public void recalcularSaldos(final int year) {
	...
	public SaldoDeCuenta recalcularSaldo(CuentaContable cuenta, final int year) {
		...
		for(ConceptoContable concepto:saldo.getCuenta().getConceptos()){			
			...
			Object params[]={concepto.getId(),year,"CIERRE_ANUAL"};
