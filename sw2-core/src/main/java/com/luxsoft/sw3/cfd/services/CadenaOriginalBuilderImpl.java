...
@Component("cadenaOriginalBuilder")
public class CadenaOriginalBuilderImpl implements CadenaOriginalBuilder{
	...
	public String obtenerCadena(ComprobanteDocument comprobante) throws RuntimeException{		
        ...
        try
        {
            String fileTemp= "~" + new Date().getTime()+".tmp";
            File file = new File(getTempDir(),fileTemp);            
            OutputStream out = new FileOutputStream(file);
            
            /*
            TransformerFactory tFactory = TransformerFactory.newInstance();
            FileInputStream is=new FileInputStream("C:\\pruebas\\cfd\\prueba2\\cadenaoriginal_2_0.xslt");
	...
	public Transformer getTransofrmer(){
		if(transformer==null){
			...
			System.out.println("Ruta de XSLT: "+xsltResource.getPath());
			Assert.isTrue(xsltResource.exists(),"Imposible localizar los archivos xslt para la cadena orignal usando la llave: "+"cfd.xslt.path");
			StreamSource xslt;
			try {
				...
				//e.printStackTrace();
				throw new RuntimeException("Error procesando xslt: "+ExceptionUtils.getRootCauseMessage(e));
			}
	...
	public File getTempDir(){
		...
		System.out.println("Directorio temporal: "+tempDir.getPath());
		return tempDir;
	...
	public static void main(String[] args) throws Exception{
		...
		String path="c:\\CFD\\xml\\9CRE0001154.xml";
