...
public class SolicitudDeModificacion {
	...
	public static enum Modulo{
		...
		DEPOSITOS("IMPORTE","CLIENTE","BANCO","FOMRA_DE_PAGO"),
		EMBARQUES("CORRECCION","LIBERACION","CANCELACION"),
		CLIENTES("MODIFICACION_DATOS"),
		COBRANZA("IMPORTE","FORMA_DE_PAGO","CANCELACION_DE_PAGO","MODIFICACION_DE_PAGO"),
