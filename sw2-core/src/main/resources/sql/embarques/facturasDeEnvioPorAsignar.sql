...
FROM sx_ventas v JOIN sx_clientes C ON(C.CLIENTE_ID=V.CLIENTE_ID) where V.FECHA>='2013/09/28' AND V.INSTRUCCION_ENTREGA IS NOT NULL AND IFNULL(V.COMENTARIO2,'') NOT LIKE '%CANCELAD%'
