 ...
 *
 */
public class ExistenciasPanel extends DefaultSucursalReplicaPanel<Existencia>{
	...
	protected List<Existencia> findData() {
		String hql="from Existencia e where e.year=? and e.mes=? and e.sucursal.id=? ";
		return ServiceLocator2.getHibernateTemplate().find(hql, new Object[]{getYear(),getMes(),sucursalId});
	}
