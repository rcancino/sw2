 ...
 *
 */
public class PolizaDeAlmacenModel {
	...
	public List<Poliza> generarPoliza(final Date dia){
		...
		String hql="from CXPAnalisisDet d where date(d.entrada.fecha)=? and d.factura.clave<>\'I001\'" +
		" order by d.factura.proveedor.clave, d.factura.documento";
		...
		final Comparator<CXPAnalisisDet> c=GlazedLists.beanPropertyComparator(CXPAnalisisDet.class, "entrada.sucursal.id");
		GroupingList<CXPAnalisisDet> entradasPorSucursal=new GroupingList<CXPAnalisisDet>(entradasTodas,c);
		for(List<CXPAnalisisDet> grupo:entradasPorSucursal){
			EventList<CXPAnalisisDet> entradas=GlazedLists.eventList(grupo);
			final Poliza pol=new Poliza();
	...
	private void cargoAlmacen(final EventList<CXPAnalisisDet> entradas,final Poliza pol){		
		...
		final Comparator<CXPAnalisisDet> c=GlazedLists.beanPropertyComparator(CXPAnalisisDet.class, "entrada.sucursal.id","factura.id");
	...
	public static void main(String[] args) {
		PolizaDeAlmacenModel model=new PolizaDeAlmacenModel();
