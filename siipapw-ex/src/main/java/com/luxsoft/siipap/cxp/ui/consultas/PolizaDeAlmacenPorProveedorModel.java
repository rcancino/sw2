 ...
 *
 */
public class PolizaDeAlmacenPorProveedorModel {
	...
	private void cargoAlmacen(final EventList<AnalisisDeFacturaDet> entradas,final Poliza pol){		
		...
		Comparator<AnalisisDeFacturaDet> c=GlazedLists.beanPropertyComparator(AnalisisDeFacturaDet.class, "entrada.sucursal.id","analisis.factura.id");
		...
		for(List<AnalisisDeFacturaDet> grupo:grupos){
			...
			for(AnalisisDeFacturaDet det:grupo){
		...
		c=GlazedLists.beanPropertyComparator(AnalisisDeFacturaDet.class, "analisis.factura.id");
		grupos=new GroupingList<AnalisisDeFacturaDet>(entradas,c);
		for(List<AnalisisDeFacturaDet> grupo:grupos){
	...
	public static void main(String[] args) {
		PolizaDeAlmacenPorProveedorModel model=new PolizaDeAlmacenPorProveedorModel();
