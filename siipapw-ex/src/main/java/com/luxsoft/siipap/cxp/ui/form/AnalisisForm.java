 ...
 * 
 */
public class AnalisisForm extends AbstractMasterDetailForm {

	private HeaderPanel header;

	public AnalisisForm(AnalisisModel model) {
		super(model);
	...
	private AnalisisModel getAnalisisModel(){
		return (AnalisisModel)model;
	}
	...
	protected JComponent buildMasterForm() {
		...
		builder.append("Fraccionada", getControl("fraccionada"),true);
	...
	protected void doEdit(Object obj) {
		...
		final AnalisisDetForm form=new AnalisisDetForm(source);
		form.open();
