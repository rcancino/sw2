 ...
 *
 */
public class VentasSinCosto extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("INVENT/VentasSinCostoP.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Ventas Sin Costo Promedio");
		}
		...
		protected JComponent buildHeader(){
			return new Header("Ventas Sin Costo Promedio","").getHeader();
		}
		...
		public void doApply() {			
			...
			String fechaIni=df.format(fechaInicial.getDate()).toString().concat(" 00:00:00");
			
			
			String fechaFin=df.format(fechaFinal.getDate()).toString().concat(" 23:00:00");
	...
	public static void run(){
		VentasSinCosto action=new VentasSinCosto();
		action.execute();
	}
