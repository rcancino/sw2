 ...
 *
 */
public class ComparativoVentasXLinea extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("BI/VentasXLineaEnKilosComp.jasper"), form.getParametros());
			else 
		    ReportUtils.viewReport(ReportUtils.toReportesPath("BI/VentasXLineaEnPesosComp.jasper"), form.getParametros());
...
/*
	...
	public static void run(){
		ComparativoVentasXLinea action=new ComparativoVentasXLinea();
		action.execute();
