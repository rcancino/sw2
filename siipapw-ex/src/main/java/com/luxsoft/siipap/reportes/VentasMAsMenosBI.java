 ...
 *
 */
public class VentasMAsMenosBI extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("ventas/VentasMasMenos.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Relación de Ventas Mas Menos","").getHeader();
		}
	...
	public static void run(){
		VentasMAsMenosBI action=new VentasMAsMenosBI();
		action.execute();
	}
