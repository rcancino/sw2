 ...
 *
 */
public class DetalleDeDevolucionesReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("INVENT/DevolucionesDetalle.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Detalle de Devoluciones","").getHeader();
		}
	...
	public static void run(){
		DetalleDeDevolucionesReport action=new DetalleDeDevolucionesReport();
		action.execute();
	}
