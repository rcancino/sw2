 ...
 *
 */
public class LineasMejoresClientes extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			if(logger.isDebugEnabled()){
				...
				ReportUtils.viewReport(ReportUtils.toReportesPath("BI/MejoresClientesXLinea.jasper"), form.getParametros());
...
public  class ParamLabelValue{
		...
		public ReportForm() {
			super("Mejores Clientes Por Línea");
	...
	public static void run(){
		LineasMejoresClientes action =new LineasMejoresClientes();
		action.execute();
