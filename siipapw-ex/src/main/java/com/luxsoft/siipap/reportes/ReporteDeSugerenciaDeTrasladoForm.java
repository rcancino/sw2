...
/**
 * Forma para ejecutar el reporte Sugerencia de Traslados entre Sucursales
 * 
 * @author Ruben Cancino
 *
 */
public class ReporteDeSugerenciaDeTrasladoForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("compras/SugerenciaDeTrasladosSuc.jasper"), form.getParametros());
			}
			else {
				System.out.println("Parametros enviados: "+form.getParametros());
				ReportUtils.viewReport(ReportUtils.toReportesPath("compras/SugerenciaDeTraslados.jasper"), form.getParametros());
			}
	...
	public static void run(){
		ReporteDeSugerenciaDeTrasladoForm action=new ReporteDeSugerenciaDeTrasladoForm();
		action.execute();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Reporte Sugerencia de Traslados");
		...
		protected JComponent buildContent() {
			...
			builder.nextLine();
			builder.append("Alcance Menor a",mesesF);
			builder.nextLine();
			//builder.append("Filtro ",filtrosBox);
			builder.append("Alc. Sucs. Mayor a",meses);			
			//builder.nextLine();
			//builder.append("Tipo",filtro2Box);
			builder.nextLine();
			builder.append("Sug.Traslados Suc.",alcance);
