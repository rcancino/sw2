 ...
 *
 */
public class MovInventDetalle extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("INVENT/MovInventariosDetalle.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Movimientos De Inventarios (Detalle)","").getHeader();
		}
	...
	public static void run(){
		MovInventDetalle action=new MovInventDetalle();
		action.execute();
	}
