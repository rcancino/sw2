 ...
 *
 */
public class ComisionPorChofer extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("embarques/ComisionesChofer.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public void doApply() {			
			...
			if(ch!=null)
				parametros.put("CHOFER_ID", ch.getId());			
	...
	public static void run(){
		ComisionPorChofer action=new ComisionPorChofer();
		action.execute();
	}
