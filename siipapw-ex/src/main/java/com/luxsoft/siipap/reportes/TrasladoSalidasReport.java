 ...
 *
 */
public class TrasladoSalidasReport extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("invent/SalidaDeTrasladoG_Det.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Reporte de Traspaso Salidas","").getHeader();
		}
	...
	public static void run(){
		TrasladoSalidasReport action=new TrasladoSalidasReport();
		action.execute();
	}
