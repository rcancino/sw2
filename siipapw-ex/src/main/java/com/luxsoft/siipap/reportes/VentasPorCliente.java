 ...
 *
 */
public class VentasPorCliente extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			if(logger.isDebugEnabled()){
				...
				ReportUtils.viewReport(ReportUtils.toReportesPath("BI/VentasClienteResumen.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
	 ...
	 public static void run(){
		 VentasPorCliente action =new VentasPorCliente();
		 action.execute();
