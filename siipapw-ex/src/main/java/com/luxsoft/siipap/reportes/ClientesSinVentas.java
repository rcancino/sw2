 ...
 *
 */
public class ClientesSinVentas extends SWXAction{
	...
	public static void run(){
		ClientesSinVentas action=new ClientesSinVentas();
		action.execute();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Reporte De Clientes sin Venta");
