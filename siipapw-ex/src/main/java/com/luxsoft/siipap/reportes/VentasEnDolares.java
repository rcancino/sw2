 ...
 *
 */
public class VentasEnDolares extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			ReportUtils.viewReport(ReportUtils.toReportesPath("Ventas/VentasDolares.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Relación de ventas en dolares","").getHeader();
		}
	...
	public static void run(){
		VentasEnDolares action=new VentasEnDolares();
		action.execute();
	}
