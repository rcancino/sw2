 ...
 *
 */
public class ComparativoMejoresClientes extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("BI/MejoresClientesEnKilosComp.jasper"), form.getParametros());
			else 
		    ReportUtils.viewReport(ReportUtils.toReportesPath("BI/MejoresClientesEnPesosComp.jasper"), form.getParametros());
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildContent() {
			...
			builder.nextLine();
			builder.append("Ao 1 ", jYearPrincipal,1);
			builder.nextLine();
			builder.append("Ao 2 ", jYearCompara);
			builder.nextLine();
	...
	public static void run(){
		ComparativoMejoresClientes action=new ComparativoMejoresClientes();
		action.execute();
