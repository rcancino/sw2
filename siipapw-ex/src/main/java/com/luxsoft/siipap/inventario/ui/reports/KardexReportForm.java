 ...
 *
 */
public class KardexReportForm extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("invent/KardexSuc.jasper"), form.getParametros());
		}
		form.dispose();
	...
	public static void run(){
		KardexReportForm action=new KardexReportForm();
		action.execute();
	}
