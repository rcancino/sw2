...
public class Proc_NotaDeCreditoDevolucionJur implements IProcesador{
	...
	void procesar(Poliza poliza, Abono entidad) {
		...
		PolizaDetFactory.generarPolizaDet(poliza,"106", "CRECTE", false, total,desc2, ref1, ref2, asiento);
