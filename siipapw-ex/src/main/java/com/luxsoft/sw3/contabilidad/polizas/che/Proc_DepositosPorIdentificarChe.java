...
public class Proc_DepositosPorIdentificarChe implements IProcesador{
	...
	void procesar(Poliza poliza, Abono entidad) {
		...
		//Acredores diversos
		PolizaDetFactory.generarPolizaDet(poliza, "203", "DEPI01", true, importeAbono, desc2, ref1, ref2, asiento);
		//Iva en ventas por trasladar
		PolizaDetFactory.generarPolizaDet(poliza, "206", "IVAD01", true, impuestoAbono, desc2, ref1, ref2, asiento);
