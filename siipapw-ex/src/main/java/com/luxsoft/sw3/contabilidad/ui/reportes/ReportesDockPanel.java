...
public class ReportesDockPanel extends AbstractView {
	...
	private JComponent buildReportTree(){
		...
		rootNode=new DefaultMutableTreeNode("Conecciones (JMS)",true);
	...
	private void load(){
		...
		/*
		for(String[] row:ReplicadorCentralManager.getInstance().getBrokers()){
	...
	private class ReplicadorRenderer extends DefaultTreeCellRenderer{
		...
		public Component getTreeCellRendererComponent(JTree tree, Object value,
			...
			if(node.getUserObject() instanceof AbstractEnterpriseReplicator){
				...
				ReportNode f=(ReportNode)node.getUserObject();				
				setText(f.getNombre());
