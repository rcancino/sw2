...
public class Proc_AplicacionDeAnticiposJur implements IProcesador{
	...
	public void procesar(Poliza poliza, ModelMap model) {
		...
		//		PolizaDetFactory.generarPolizaDet(poliza, "206", "IVAV05", true, ivaAplicado, "IVA TRASLADADO ANTICIPOS", ref1, ref2, asiento);
				...
				PolizaDetFactory.generarPolizaDet(poliza,"114", pago.getClave(), false, totalAplicado, "Aplicacion de anticipo JUR", ref1, ref2, asiento);
