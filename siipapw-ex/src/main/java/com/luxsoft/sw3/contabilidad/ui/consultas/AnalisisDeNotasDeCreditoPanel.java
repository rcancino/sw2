...
public class AnalisisDeNotasDeCreditoPanel extends AbstractMasterDatailFilteredBrowserPanel<NotaDeCredito, Aplicacion>{
	
	private String origen="CRE";
	private Date fecha;

	public AnalisisDeNotasDeCreditoPanel() {
	...
	public static void show(final Date fecha,final String origen){
		final AnalisisDeNotasDeCreditoPanel browser=new AnalisisDeNotasDeCreditoPanel();
