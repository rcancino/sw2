...
public class PolizaDePagosTesoreriaPanel extends PolizaDinamicaPanel{

	public PolizaDePagosTesoreriaPanel(ControladorDinamico controller) {
		super(controller);
	...
	protected List<Poliza> findData() {
		...
		Object[] params={getClase(),periodo.getFechaInicial(),periodo.getFechaFinal(),"TESORERIA:%"};
