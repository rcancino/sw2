...
import com.luxsoft.sw3.contabilidad.services.PolizaDeChequesDevueltosManager;

public class PolizaDeChequesDevueltosPanel extends PanelGenericoDePoliza{
	
	

	public PolizaDeChequesDevueltosPanel() {
		super();
		setClase("CXC CHEQUES DEVUELTOS");
		setManager(new PolizaDeChequesDevueltosManager());
	}
