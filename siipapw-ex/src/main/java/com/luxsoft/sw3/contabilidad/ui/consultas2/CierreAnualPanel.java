...
import com.luxsoft.sw3.contabilidad.ui.consultas.AnalisisDeBalanzaDetPanel;
import com.luxsoft.sw3.contabilidad.ui.consultas.AnalisisDeBalanzaPorCuentaPanel;

public class CierreAnualPanel extends AbstractMasterDatailFilteredBrowserPanel<SaldoDeCuenta,SaldoDeCuentaPorConcepto>{

	public CierreAnualPanel() {
	...
	public void cambiarPeriodo() {
		...
		if(!dialog.hasBeenCanceled()){
			periodo=Periodo.getPeriodoDelYear(yearModel.intValue());
	...
	public void drill(SaldoDeCuentaPorConcepto det){
		System.out.println("Taladrando para: "+det);
	...
	protected List<SaldoDeCuenta> findData() {
		String hql="from SaldoDeCuenta s where s.year=? and s.mes=13";
		Object[] values={Periodo.obtenerYear(periodo.getFechaFinal())};
	...
	public Action[] getActions() {
		if(actions==null){
			...
			actions=new Action[]{
				...
				,addAction(null,"cierreAnual","Genera cierre")
				};
		}
		return actions;
	}
	...
	public void cierreAnual(){
		...
		if(MessageUtils.showConfirmationMessage("Registrar cierre anual: "+year, "Cierre anual")){
