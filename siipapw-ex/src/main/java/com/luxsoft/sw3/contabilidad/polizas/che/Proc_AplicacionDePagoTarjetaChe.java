...
public class Proc_AplicacionDePagoTarjetaChe implements IProcesador{
	...
	public void procesar(Poliza poliza, ModelMap model) {
		...
		for(final Pago pago:pagos){
			...
			if(DateUtils.isSameDay(poliza.getFecha(), pago.getPrimeraAplicacion())){
				...
				//Abono Clientes
				PolizaDetFactory.generarPolizaDet(poliza,"113", pago.getClave(), false, totalAplicado, "Clientes Aplic anticipo", ref1, ref2, asiento);
