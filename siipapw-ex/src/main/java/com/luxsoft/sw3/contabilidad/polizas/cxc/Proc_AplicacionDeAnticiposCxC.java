...
public class Proc_AplicacionDeAnticiposCxC implements IProcesador{
	...
	public void procesar(Poliza poliza, ModelMap model) {
		...
		for(Pago pago:pagos){
			if(pago.isAnticipo()){
				...
				PolizaDetFactory.generarPolizaDet(poliza, "204",pago.getClave(), true, importeAplicado, desc2, "CRE", ref2, asiento);
	...
	//			PolizaDetFactory.generarPolizaDet(poliza, "206", "IVAV05", true, ivaAplicado, "IVA TRASLADADO ANTICIPOS", ref1, ref2, asiento);
				...
				PolizaDetFactory.generarPolizaDet(poliza,"106", pago.getClave(), false, totalAplicado, "Clientes aplic anticipo", "CRE", ref2, asiento);
				
				
				//Cargo Iva en ventas por trasladar
				PolizaDetFactory.generarPolizaDet(poliza, "206", "IVAV02", true, ivaAplicado, "IVA x TRASLADAR ANTICIPO", "CRE", ref2, asiento);
				//Abono Iva en ventas
	//			PolizaDetFactory.generarPolizaDet(poliza, "206", "IVAV01", false, ivaAplicado, "IVA TRASLADADO ANTICIPO", ref1, ref2, asiento);
				
				//Cancelacion de IETU
				PolizaDetFactory.generarPolizaDet(poliza, "902", "AIETU05", false, importeAplicado, "ACUMULABLE IETU ANTICIPO", "CRE", ref2, asiento);
				PolizaDetFactory.generarPolizaDet(poliza, "903", "IETUA05", true, importeAplicado,"IETU ACUMULABLE ANTICIPO", "CRE", ref2, asiento);
				//IETU Credito
