...
public class Proc_NotasDeCargo_Che implements IProcesador{
...
void procesar(Poliza poliza, Cargo entidad) {
		...
		//for(NotaDeCargoDet det:cargo.getConceptos()){
			...
			if(cargo.getOrigen().equals(OrigenDeOperacion.CHE)){
				...
				PolizaDetFactory.generarPolizaDet(poliza, "702", "OING04", false, importe,desc2, ref1, ref2, asiento);
