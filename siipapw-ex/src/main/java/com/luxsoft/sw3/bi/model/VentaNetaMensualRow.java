 ...
 *
 */
public class VentaNetaMensualRow implements Serializable{
	...
	public void setPorcentajeAportacion(BigDecimal porcentajeAportacion) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VentaNetaMensualRow other = (VentaNetaMensualRow) obj;
		return true;
	}
