 ...
 *
 */
public class PlantillaGenericaDeReporte extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){
			...
			ReportUtils.viewReport(ReportUtils.toReportesPath("compras/MesesDeInventario.jasper"), form.getParametros());
			}
			else {
				System.out.println("Parametros enviados: "+form.getParametros());
				ReportUtils.viewReport(ReportUtils.toReportesPath("compras/GeneralDeAlcance.jasper"), form.getParametros());
			}
	...
	public static void run(){
		PlantillaGenericaDeReporte action=new PlantillaGenericaDeReporte();
		action.execute();
	}
	...
	public static void main(String[] args) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				PlantillaGenericaDeReporte.run();
				//System.exit(0);
			}
