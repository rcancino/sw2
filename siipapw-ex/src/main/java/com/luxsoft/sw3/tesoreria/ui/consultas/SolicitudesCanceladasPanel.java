...
/**
 * Panel para el mantenimiento de solicitudes de depositos canceladas
 * 
 * @author Ruben Cancino Ramos
 *
 */
public class SolicitudesCanceladasPanel extends FilteredBrowserPanel<SolicitudDeDeposito> implements ApplicationContextAware{
	
	private ApplicationContext context;
	
	public SolicitudesCanceladasPanel() {
	...
	protected List<SolicitudDeDeposito> findData() {
		String hql="from SolicitudDeDeposito s left join fetch s.cliente c" +
				...
				" where s.cancelacion is not null and date(s.fecha) between ? and ?";
