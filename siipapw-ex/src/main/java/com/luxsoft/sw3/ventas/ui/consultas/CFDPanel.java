...
/**
 * Panel de comprobantes fiscales Impresor
 * 
 * @author Ruben Cancino Ramos
 *
 */
public class CFDPanel extends FilteredBrowserPanel<ReporteMensualCFD>{
	...
	protected List<ReporteMensualCFD> findData() {
		String sql="SELECT RFC,RECEPTOR,SERIE,FOLIO,NO_APROBACION,CREADO AS FECHA,TOTAL,IMPUESTO,'1' AS ESTADO,TIPO_CFD,PEDIMENTO,PEDIMENTO_FECHA AS FECHA_PED,ADUANA FROM SX_CFD WHERE DATE(CREADO) BETWEEN ? AND ? " +
					"UNION " +
