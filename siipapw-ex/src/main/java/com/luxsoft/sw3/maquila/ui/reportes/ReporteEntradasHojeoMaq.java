 ...
 *
 */
public class ReporteEntradasHojeoMaq extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/EntradaHojeoMaq.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Relación de entradas de hojeo","").getHeader();
		}
	...
	public static void run(){
		ReporteEntradasHojeoMaq action=new ReporteEntradasHojeoMaq();
		action.execute();
	}
