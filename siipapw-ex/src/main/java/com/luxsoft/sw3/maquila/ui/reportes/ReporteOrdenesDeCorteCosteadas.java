 ...
 *
 */
public class ReporteOrdenesDeCorteCosteadas extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/Reporte_Orden_Corte.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Reporte Ordenes de Corte Costeadas");
		}
		...
		protected JComponent buildHeader(){
			return new Header("Ordenes de Corte Costeadas","").getHeader();
		}
	...
	public static void run(){
		ReporteOrdenesDeCorteCosteadas action=new ReporteOrdenesDeCorteCosteadas();
		action.execute();
	}
