 ...
 *
 */
public class ReporteDeDiferenciasEnGramaje extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/GramosReales.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Reporte de Diferencias en gramaje");
		}
		...
		protected JComponent buildHeader(){
			return new Header("Diferencias en Gramaje","").getHeader();
		}
	...
	public static void run(){
		ReporteDeDiferenciasEnGramaje action=new ReporteDeDiferenciasEnGramaje();
		action.execute();
	}
