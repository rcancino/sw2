 ...
 *
 */
public class ReporteDeInventarioEnProcesoDeCorte extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/Invent_mp_proceso.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Reporte Inventario en Proceso de Corte");
		}
		...
		protected JComponent buildHeader(){
			return new Header("Inventario en Proceso de Corte","").getHeader();
		}
	...
	public static void run(){
		ReporteDeInventarioEnProcesoDeCorte action=new ReporteDeInventarioEnProcesoDeCorte();
		action.execute();
	}
