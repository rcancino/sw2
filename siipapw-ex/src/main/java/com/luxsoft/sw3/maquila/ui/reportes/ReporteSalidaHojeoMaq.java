 ...
 *
 */
public class ReporteSalidaHojeoMaq extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/SalidaHojeoMaq.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Relación de salidas de hojeo","").getHeader();
		}
	...
	public static void run(){
		ReporteSalidaHojeoMaq action=new ReporteSalidaHojeoMaq();
		action.execute();
	}
