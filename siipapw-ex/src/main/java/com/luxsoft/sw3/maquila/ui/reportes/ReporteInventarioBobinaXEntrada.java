 ...
 *
 */
public class ReporteInventarioBobinaXEntrada extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/Inventario_mp_resumen.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Inventario Bobina por Entrada");
		}
		...
		protected JComponent buildHeader(){
			return new Header("Inventario Bobina por Entrada","").getHeader();
		}
	...
	public static void run(){
		ReporteInventarioBobinaXEntrada action=new ReporteInventarioBobinaXEntrada();
		action.execute();
	}
