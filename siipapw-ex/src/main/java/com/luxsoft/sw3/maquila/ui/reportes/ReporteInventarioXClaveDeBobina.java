 ...
 *
 */
public class ReporteInventarioXClaveDeBobina extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/Invent_mp_Alm_clave.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		public ReportForm() {
			super("Inventario Por Clave De Bobina");
		}
		...
		protected JComponent buildHeader(){
			return new Header("Inventario Por Clave De Bobina","").getHeader();
		}
	...
	public static void run(){
		ReporteInventarioXClaveDeBobina action=new ReporteInventarioXClaveDeBobina();
		action.execute();
	}
