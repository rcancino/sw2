 ...
 *
 */
public class ReporteDeEntradasCosteadas extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/Reporte_Entrada_Costeada.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public static void run(){
		ReporteDeEntradasCosteadas action=new ReporteDeEntradasCosteadas();
		action.execute();
	}
