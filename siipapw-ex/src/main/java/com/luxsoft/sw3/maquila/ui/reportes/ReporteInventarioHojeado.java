 ...
 *
 */
public class ReporteInventarioHojeado extends SWXAction{
	...
	protected void execute() {
		...
		if(!form.hasBeenCanceled()){			
			ReportUtils.viewReport(ReportUtils.toReportesPath("maquila/Inventario_hojas_global.jasper"), form.getParametros());
		}
		form.dispose();
	}
	...
	public  class ReportForm extends SXAbstractDialog{
		...
		protected JComponent buildHeader(){
			return new Header("Inventario Hojeo","").getHeader();
		}
	...
	public static void run(){
		ReporteInventarioHojeado action=new ReporteInventarioHojeado();
		action.execute();
	}
