 ...
 *
 */
public class SelectorDeComsParaAnalisisDeFlete extends AbstractSelector<EntradaPorCompra>{
	
	Periodo periodo;
	
	public SelectorDeComsParaAnalisisDeFlete() {
		super(EntradaPorCompra.class, "Entradas  por compra (COM) disponibles sin flete asignado");
	...
	public static List<EntradaPorCompra> seleccionar(){
		SelectorDeComsParaAnalisisDeFlete selector=new SelectorDeComsParaAnalisisDeFlete();
