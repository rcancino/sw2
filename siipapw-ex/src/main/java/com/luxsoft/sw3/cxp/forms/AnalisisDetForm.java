...
public class AnalisisDetForm extends SXAbstractDialog{

	private final AnalisisDeFacturaDet analisis;
	...
	public AnalisisDetForm(final AnalisisDeFacturaDet analisis) {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable(){
			public void run() {
				...
				det.setEntrada(e);
				AnalisisDetForm form=new AnalisisDetForm(det);
				form.open();
