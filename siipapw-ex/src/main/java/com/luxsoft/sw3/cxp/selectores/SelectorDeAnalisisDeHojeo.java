 ...
 *
 */
public  class SelectorDeAnalisisDeHojeo extends AbstractSelector<AnalisisDeHojeo>{
	
	
	
	protected Periodo periodo=Periodo.getPeriodoDelMesActual();
	
	public SelectorDeAnalisisDeHojeo() {
		super(AnalisisDeHojeo.class, "Análisis de hojeo");
	...
	@Override
	protected void installEditors(EventList<MatcherEditor<AnalisisDeHojeo>> editors) {
	...
	@Override
	protected TableFormat<AnalisisDeHojeo> getTableFormat() {
		...
		return GlazedLists.tableFormat(AnalisisDeHojeo.class,props,labels);
	}
	...
	@Override
	protected List<AnalisisDeHojeo> getData() {
		String hql="from AnalisisDeHojeo f where f.cxpFactura.fecha between ? and ?";
	...
	public static AnalisisDeHojeo buscar(){
		List<AnalisisDeHojeo> facturas=new ArrayList<AnalisisDeHojeo>();
		SelectorDeAnalisisDeHojeo selector=new SelectorDeAnalisisDeHojeo();
	...
	public static List<AnalisisDeHojeo> find(){
		List<AnalisisDeHojeo> facturas=new ArrayList<AnalisisDeHojeo>();
		SelectorDeAnalisisDeHojeo selector=new SelectorDeAnalisisDeHojeo();
